...
*/
/* DIJIMOS QUE PARA FACTOREAR ERA 4!
0! = 1
1! = 1
2! = 2 * 1!
3! = 3 * 2!
...
n = factorial -1 (uno menos que el valor de "n") * n
*/
...
LA SECUENCIA FIBONACCI CONSISTE EN QUE EL NUMERO ES LA SUMA DE LOS DOS ANTERIORES
nfibonacci(n - 2) + nFibonacci(n - 1)
Ej:
nFibonacci = [0,1]
nfibonacci(n - 2) = 0 /// nfibonacci(n - 1) = 1
              0        +        1     === 1
            nFibonacci =[0,1,1]
 */
...
class Queue {
  ...
  dequeue(valor){
    return this.cadena.shift(valor);
  }
  size(){
